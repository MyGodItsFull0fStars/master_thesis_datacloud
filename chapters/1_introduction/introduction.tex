...
\label{ch:introduction}
    ...
    This interconnected network of computers increases by the day and results in an immense amount of data being produced, which is commonly referred to as \emph{Big Data}.
    ...
    The \emph{Cloud} physically resides in large-scale data centres that enable applications to quickly scale depending on resource utilisation spikes. Additionally, they possess the required computing power to analyse Big Data in a performant manner.
