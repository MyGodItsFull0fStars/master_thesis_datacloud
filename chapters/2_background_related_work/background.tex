...
\label{ch:background}
    ...
    \label{sec:scheduling-and-adaptation-background}
        ...
        \label{sec:scheduling-background}
            ...
            \label{sec:static-scheduling-background}
                ...
                Static schedules are fixed before execution based on the information that is available to the scheduler at that time.
                The schedule is therefore also said to be compiled (done in compile time).
                ...
                Since most static schedulers are rather simple, additional advantages are their predictability and low complexity.
                ...
                % todo add examples of static scheduling algorithms

            \subsubsection{Dynamic Scheduling}
            \label{sec:dynamic-scheduling-background}

                Dynamic schedules are determined during the runtime and might change while executing.
                In this scheduling type, the scheduler rearranges the tasks to reduce stalls of the resources while maintaining data flow and exception behaviour.
                ...
                % TODO add examples of dynamic scheduling algorithms
        

            \subsubsection{Adaptation}
            \label{sec:adaptation-background}

                % Adaptive scheduling algorithms are a subset of dynamic scheduling algorithms.
                % Adaptive algorithms do use system-state information to a further degree.
                % In an adaptive system, the scheduling policy reflects changes in its environment (i.e. the running system).

                Adaptation in the context of this master's thesis is the process of modifying the given information of tasks to a more accurate representation of their behaviour before providing the tasks to a scheduler.
    ...
    \label{sec:rnn-background}
        ...
        \label{sec:shortcomings-of-rnns-background}
            ...
            \label{par:vanishing-gradients-background}
                 ...
                 problem occurs when many of the values (i.e. weight matrices or gradients themselves) that are involved in the repeated gradient computations are too small or less than 1. Opposed to the \nameref{par:exploding-gradients-background} problem, the gradients become smaller with each repeated computation of the gradients.
    ...
    \label{sec:stacked-lstm}
        ...
        % TODO find a better wording for the sentence below
