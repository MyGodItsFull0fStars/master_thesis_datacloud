...
\label{ch:background}
    ...
    \label{sec:supervised-learning}
        ...
        \label{sec:regression-supervised-learning-background}
            ...
            The blue dots in the figure show the actual values. In this example, they represent the number of cats owned at a certain age. \emph{Note that this is a fictive scenario}.
