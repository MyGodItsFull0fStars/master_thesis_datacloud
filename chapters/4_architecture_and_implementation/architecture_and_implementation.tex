...
\label{sec:scheduling-and-adaptation-approach-architecture}
  ...
  \label{sec:adaptation-saa-background}
      ...
      The usual execution order is represented by the order the components are mentioned in this section.
      ...
      Otherwise, an event is triggered that is sent to the Analysis component (see \ref{par:analysis-component-saa-background}) that will adapt the affected resource to function in expected limits again.

      \paragraph{Analysis Component }
      \label{par:analysis-component-saa-background}
      
      is used to analyse the current state of the distributed system and its resources.
      
      
      
      \paragraph{Adapt Component }
