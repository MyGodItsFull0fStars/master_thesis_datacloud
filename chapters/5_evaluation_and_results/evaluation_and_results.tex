...
% what is common in the scenarios (or some of them)
  ...
  \label{sec:adding-task-knowledge-evaluation-scenarios}
    ...
    \label{sec:cpu-prediction-analysis-task-knowledge-lstm-evaluation}
      ...
      In this section, the memory prediction of the Task LSTM model and the user-provided prediction are compared in tables \ref{tab:comparison-task-lstm-user-predicted-cpu} and \ref{tab:regression-metrics-task-lstm-user-predicted-cpu}.
