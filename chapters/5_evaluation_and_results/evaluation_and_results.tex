...
% what is common in the scenarios (or some of them)
  ...
  \label{sec:training-with-custom-loss-function-evaluation-scenarios}
    ...
    \label{sec:cpu-prediction-analysis-pmse-lstm-evaluation}
      ...
      In this section, the CPU prediction of the Penalty LSTM is compared to the prediction variants mentioned in section \ref{sec:adding-instance-knowledge-evaluation-scenarios}.
