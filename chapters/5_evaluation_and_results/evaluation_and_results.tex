  ...
  \label{sec:simple-feature-set-evaluation-scenarios}
    ...
    \begin{table}
      ...
      \begin{tabular}{|l|rrrrr|}
        ...
        {} &     RMSE &     MAPE &   SMAPE &     OA &     UA \\
        \midrule
        Simple LSTM &  701.099 &  868.561 &  92.649 &  57.34 &  42.66 \\
    ...
    \begin{table}
      ...
      \begin{tabular}{|l|rr|}
        \toprule
        {} &  Predicted Max. Memory &  Actual Memory Usage \\
        \midrule
        mean       &          26.89 &             17.20 \\
        std        &          15.26 &             74.76 \\
        min        &           2.00 &              0.00 \\
    ...
    \begin{table}
      ...
      \begin{tabular}{|l|rrrrr|}
        ...
        {} &    RMSE &     MAPE &   SMAPE &     OA &     UA \\
        \midrule
        Simple LSTM &  14.725 &  128.113 &  87.045 &  36.28 &  63.72 \\
  ...
  \label{sec:adding-task-knowledge-evaluation-scenarios}
    ...
    \label{sec:mem-prediction-analysis-task-knowledge-lstm-evaluation}
      ...
      \begin{figure}
        ...
        \begin{tabular}{|l|rr|}
          \toprule
          {} &  Predicted Memory Usage &  Actual Memory Usage \\
          \midrule
          mean       &                 3.78 &              8.84 \\
          std        &                 4.20 &             10.55 \\
          min        &                 0.14 &              0.02 \\
