...
\setsubsecheadstyle{\normalfont\large\bfseries}
\setparaheadstyle{\normalfont\normalsize\bfseries}
% \setparaindent{5pt}\setafterparaskip{0pt}
...
\makeatletter
\makeevenfoot{chap}{}{\small\bfseries\thepage}{} % Define new chapter page style
...
\nouppercaseheads
\pagestyle{standard}               % Choosing page style and chapter page style
...
\begin{document}
  ...
  % \includegraphics[width=0.9\textwidth]{chapters/Titelblatt.pdf}
  ...
  \import{chapters/}{acknowledgement.tex}
  \pagebreak
  \import{chapters/}{affidavit.tex}
